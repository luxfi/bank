...
export class RiskAssessment extends BaseEntity {
  ...
  async updateFromDto(data: RiskAssessmentDto) {
    ...
    this.sourceOfFoundsAreFundsAssetsComingFromA3d2 = data.sourceOfFoundsAreFundsAssetsComingFromA3d2;
    this.sourceOfFoundsAreFundsAssetsComingFromA3d2Details = data.sourceOfFoundsAreFundsAssetsComingFromA3d2Details;
    this.completeAnyNotesRegardingRiskAssessment = data.completeAnyNotesRegardingRiskAssessment;
    this.completeAssessmentCompleteByName = data.completeAssessmentCompleteByName;
    ...
    if (data.completionDate) {
      if (data.riskRating?.toLowerCase() === 'high')
        this.nextRiskAssessment = dayjs(data.completionDate).add(12, 'month').toDate();
      else
        this.nextRiskAssessment = dayjs(data.completionDate).add(36, 'month').toDate();
    }
  }
}
