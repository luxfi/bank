...
import { InputsContainer, MainContainer, StyledInput } from './styles';
...
const TwoFactorCodeInput = forwardRef<AuthCodeRef, AuthCodeProps>(
  (
    {
    ...
    return (
      <MainContainer>
        <InputsContainer
          className={`${containerClassName} ${errorMsg && 'hasError'}`}
        >
          {inputs}
        </InputsContainer>
