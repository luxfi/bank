          ...
          <Stack gap={32}>
            ...
            <Stack gap={20}>
              ...
              <BankField label="First Name" error={fieldError('firstname')}>
                <input
                  style={bankInputStyle} className={`bank-input ${fieldError('firstname') ? "bank-input-invalid" : ""}`}
              ...
              <BankField label="Last Name" error={fieldError('lastname')}>
                <input
                  style={bankInputStyle} className={`bank-input ${fieldError('lastname') ? "bank-input-invalid" : ""}`}
              ...
              <BankField label="Email" error={fieldError('email')}>
                <input
                  style={bankInputStyle} className={`bank-input ${fieldError('email') ? "bank-input-invalid" : ""}`}
                  type="email"
                  inputMode="email"
              ...
              <BankField label="Mobile Number" error={fieldError('mobileNumber')}>
                <input
                  style={bankInputStyle} className={`bank-input ${fieldError('mobileNumber') ? "bank-input-invalid" : ""}`}
                  type="tel"
                  inputMode="tel"
                  placeholder="+44..."
                  disabled={formActions.loading}
