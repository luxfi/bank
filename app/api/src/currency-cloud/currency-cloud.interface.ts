...
export interface CurrencyCloudInterface {
    createAccount(account: CreateCurrencyCloudAccountDto, user: User): Promise<string>;
    
    createContact(contact: CreateCurrencyCloudContactDto, user: User): Promise<string>;

    validateBeneficiaryToCreate(beneficiary: CreateCurrencyCloudBeneficiaryDto, contactId: string, user: User): Promise<void>;

    createBeneficiary(beneficiary: CreateCurrencyCloudBeneficiaryDto, contactId: string, user: User): Promise<string[]>;
