...
export interface OpenPaydInterface {
    ...
    validateBeneficiaryToCreate(beneficiary: CreateOpenPaydBeneficiaryDto, user?: User): Promise<void>;

    createBeneficiary(beneficiary: CreateOpenPaydBeneficiaryDto, payment_types: string[], user?: User): Promise<string[]>;
