...
export class TransactionsRepository extends EntityRepository<Transaction> {
  ...
  async findRecentBeneficiariesByUserId(
    clientId: string,
    ...
    // Ajustando o formato do retorno para incluir dados e paginação
    return {
