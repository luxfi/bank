...
export class HeaderCurrencyCloudDTO {
  @ApiProperty()
  message_type: string;
...
export class WebhookCurrencyCloudDTO {
  @ApiProperty()
  body: CurrencyCloudDTO;

  @ApiProperty()
  header: HeaderCurrencyCloudDTO;
}
