import { ECountryCode, ECurrencyCode, SuccessResponseV2 } from '@tools/misc';
...
export class GetBeneficiaryDetailResponse
  implements SuccessResponseV2<BeneficiaryDetail>
{
