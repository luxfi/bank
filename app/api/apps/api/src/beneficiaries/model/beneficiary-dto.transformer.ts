...
import { AccountType, Beneficiary, CreateBeneficiaryDto } from '@tools/models';
...
} from '../../currency-cloud/model/routing-code-type.enum';

export function createCurrencyCloudBeneficiaryDto(
  data: CreateBeneficiaryDto | Beneficiary,
): CreateCurrencyCloudBeneficiaryDto {
