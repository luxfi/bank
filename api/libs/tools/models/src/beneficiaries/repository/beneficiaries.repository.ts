...
import {
  ...
  PaginationsResponse,
} from '@domain/use-cases/get-beneficiaries/types/beneficiary.response.type';
import { FilterQuery } from '@mikro-orm/core';
import { ECountryCode, ECurrencyCode } from '@tools/misc';
import { GetBeneficiariesRequest } from '@domain/use-cases/get-beneficiaries/types/benefiary.request.type';
import { FilterBeneficiariesDTO } from '../dtos/filter-beneficiaries.request.dto';
import {
  GetBeneficiariesSelectPaginatedResponse,
  GetBeneficiariesSelectResponse,
} from '@domain/use-cases/get-beneficiaries-by-select/types/beneficiary.response.type';
import { GetBeneficiariesSelectRequest } from '@domain/use-cases/get-beneficiaries-by-select/types/benefiary.request.type';
...
export class BeneficiariesRepository extends EntityRepository<Beneficiary> {
  ...
  async findActiveByUserToSelectPaginated(
    params: GetBeneficiariesSelectRequest,
    user: User,
  ...
  async findBeneficiariesByAccount(
    accountUuid: string,
