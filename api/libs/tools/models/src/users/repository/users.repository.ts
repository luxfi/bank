...
import { ListUsersSelectResponse } from '@domain/use-cases/get-users-by-select/types/get-users.response.type';
...
export class UsersRepository extends EntityRepository<User> {
  ...
  async findByCurrencyCloudIds(
    cloudCurrencyIds: string[],
  ): Promise<User[] | null> {
    return this.find(
      {
        contact: {
  ...
  async findAllPaginated(
    ...
    // Construir critérios de filtragem
    ...
    // Realizar a consulta (a função findAndCount simula uma função ORM genérica; substitua pelo seu método ORM específico)
