...
import { compareHash, generateCodeAndHash } from '@tools/misc';
...
@Entity({ customRepository: () => InvitationsRepository })
export class Invitation extends BaseEntity {
  ...
  /** checks if the provided secret matches the invitation's */
