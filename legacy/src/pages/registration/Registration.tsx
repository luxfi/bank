...
export default function Registration() {
    ...
    if (selectedSlide === 1) {
        FormContainerElement = BasicFormContainer;
    } else if (
        selectedSlide === 3 ||
        selectedSlide === 0 ||
        selectedSlide === 10 ||
        ...
        FormContainerElement = BrFormContainer;
    } else if (selectedSlide === 4) {
        FormContainerElement = PasswordFormContainer;
    } else {
        FormContainerElement = FormContainer;
    }
    return (
        <Layout
