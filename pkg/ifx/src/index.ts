...
export class PaymentProviderIFX {
  ...
  async getWallets(params?: PaginationParams): Promise<PaginationWrapper<Wallet>> {
    try {
      const { data } = await this.coreRequester.get('/wallets', {params} as AxiosRequestConfig);
      return data;
    } 
    catch (error) {
  ...
  async createAccountBeneficiary(id: string, body: AccountBeneficiary): Promise<BeneficiaryCreated> {
    try {
  ...
  async listBeneficiaries(params?: PaginationParams): Promise<PaginationWrapper<Beneficiary>> {
    try {
      const { data } = await this.coreRequester.get('/beneficiaries', {params} as AxiosRequestConfig);
      return data;
    } 
    catch (error) {
      throw new IFXErrorResponse(error as any);
  ...
  async detailBeneficiary(id: string, params?: PaginationParams): Promise<Beneficiary> {
    try {
      const { data } = await this.coreRequester.get(`/beneficiaries/${id}`, {params} as AxiosRequestConfig);
      return data;
    } 
    catch (error) {
      throw new IFXErrorResponse(error as any);
  ...
  async detailAccountBeneficiary(id: string, params?: PaginationParams): Promise<AccountBeneficiary[]> {
    try {
      const { data } = await this.coreRequester.get(`/beneficiaries/${id}/accounts`, {params} as AxiosRequestConfig);
      return data.data;
    } 
    catch (error) {
      throw new IFXErrorResponse(error as any);
  ...
  async acceptQuote(id: string): Promise<AcceptQuote> {
    try {
      const { data } = await this.coreRequester.patch(`/quotes/${id}/accept`, {});
      return data;
    } 
    catch (error) {
      throw new IFXErrorResponse(error as any);
