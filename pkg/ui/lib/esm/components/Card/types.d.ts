...
export type TCardJustify = 'flex-start' | 'center' | 'flex-end' | 'space-between' | 'space-around' | 'space-evenly' | 'strech';
export type TCardAlign = 'flex-start' | 'center' | 'flex-end' | 'stretch' | 'baseline' | 'initial' | 'inherit';
export type TCardDirection = 'row' | 'column' | 'row-reverse' | 'column-reverse';
export type TCardWidth = 'fit-content' | 'fill' | 'max-content' | 'min-content' | string;
export type TCardHeight = 'fit-content' | 'fill' | 'max-content' | 'min-content' | string;
