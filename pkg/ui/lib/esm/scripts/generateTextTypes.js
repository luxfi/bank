...
`;
    ...
    fs.writeFile('src/components/Text/types.ts', formatted, (error) => error ? console.log(error) : console.log('Successfully created Text styles'));
})();
//# sourceMappingURL=generateTextTypes.js.map