...
`;
    ...
    fs.writeFile('src/components/Icon/types.ts', formatted, (error) => error ? console.log(error) : console.log('Successfully created Icon types'));
})();
//# sourceMappingURL=generateIconTypes.js.map