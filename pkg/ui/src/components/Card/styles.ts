...
const Container = styled.div<Transient<ICardProps>>`
  display: flex;
  ...
  border-radius: ${({ theme, $borderRadius }) =>
    $borderRadius ? theme.borderRadius[$borderRadius].value : theme.borderRadius['radius-md'].value};
  border-width: ${({ theme, $borderWidth }) =>
    $borderWidth ? theme.borderWidth[$borderWidth].value : theme.borderWidth['width-zero'].value};
