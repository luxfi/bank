                    ...
                    : <>
                        ...
                        <Formik
                            ...
                            onSubmit={async (values) => {
                                ...
                                await dispatch(submitAdminUser({ uuid: uuid || 'new' })).unwrap();
                        ...
                        >
                            <FlexibleForm>
                                ...
                                <ButtonsRow>
                                    <Button type="button" danger onClick={() => navigate('/admin/users')}>
                                        Cancel
                                    </Button>
                                    <Button type="submit" secondary>{uuid !== 'new' ? 'Update' : 'Create'} User</Button>
                                </ButtonsRow>
